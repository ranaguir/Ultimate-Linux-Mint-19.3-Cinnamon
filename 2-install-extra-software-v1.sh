...
sh install-chromium-v1.sh


###############################################################################################

# Neofetch
# Información del sistema similar a Screenfetch
sh install-neofetch-v*.sh

###############################################################################################

# Peek
# Permite grabar la pantalla como gifs animados
sh install-peek-v*.sh

###############################################################################################

# Redshift
# Maneja el color de la pantalla de acuerdo al momento del día
sh install-redshift-v*.sh

###############################################################################################

# Simplescreenrecorder
# Grabador de la pantalla para videos
...
# Variety
# Cambia los fondos de pantalla
sh install-variety-v*.sh

###############################################################################################

# Vivaldi
# Navegador basado en Opera
